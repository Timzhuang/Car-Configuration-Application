...
public abstract class ProxyAutomobile {
	...
	/*
	 * getOptionChoice: return the option choice of the given optionSet of given model
	 */
	public String getOptionChoice(String model, String optionSetName)
	{
		
		if (autoMap.containsKey(model)) // if the model exists
		{	
			return autoMap.get(model).getOptionChoice(optionSetName);
		}
		else
			System.out.println("model does not exist\n");
		return null;
